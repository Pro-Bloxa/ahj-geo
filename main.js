...
;// CONCATENATED MODULE: ./src/js/verify-coords.js
...
class Widget {
  ...
  showTicket(data) {
    ...
    this.container.querySelector(".elem").insertAdjacentElement("afterbegin", this.elem);
    this.resetInput();
  }
  showModal() {
    const modal = this.container.querySelector(".modal");
    modal.classList.remove("hidden");
    this.container.querySelector(".modal-input").addEventListener("input", this.deleteError);
